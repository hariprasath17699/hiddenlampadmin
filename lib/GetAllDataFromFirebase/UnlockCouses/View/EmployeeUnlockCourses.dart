...
class EmployeeUnlockCoursesView extends StatefulWidget {
  @override
  _EmployeeUnlockCoursesViewState createState() => _EmployeeUnlockCoursesViewState();
}

class _EmployeeUnlockCoursesViewState extends State<EmployeeUnlockCoursesView> {
