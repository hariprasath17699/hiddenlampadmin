...
import 'package:hiddenlampadmin/GetAllDataFromFirebase/UnlockCouses/View/EmployeeUnlockCourses.dart';
...
import 'package:hiddenlampadmin/UnlockCourses/View/EmployeeUnlockCourses.dart';
...
import 'Add Assignment/View/EmployeeAddAssignment.dart';
import 'Add Courses/View/EmployeeAddCourses.dart';
import 'Widgets/CustomButton.dart';

class MyEmployeeDrawer extends StatelessWidget {
  @override
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: ListTile(
              ...
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>EmployeeAddCourses()));
              },
            ),
          ),
          // Container(
          ...
          Container(
            ...
            child: ListTile(
              ...
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>EmployeeUnlockCoursesView()));
              },
            ),
          ),
          // Container(
