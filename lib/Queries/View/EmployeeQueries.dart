...
class EmployeeQueries extends StatefulWidget {
  const EmployeeQueries({super.key});

  @override
  State<EmployeeQueries> createState() => _EmployeeQueriesState();
}

class _EmployeeQueriesState extends State<EmployeeQueries> {
